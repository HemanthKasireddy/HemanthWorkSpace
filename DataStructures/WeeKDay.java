	 ...
	 public static void main(String args[])
	    {
	        ...
	        int maxDaysInMonth = weeklyCalender.findMaxDay(mname,year);
	        
	        String firstDayOfMonth=weeklyCalender.findMonthDay(year,mname);
	        
	        int dayNumberInMonth = weeklyCalender.findDayNo(firstDayOfMonth); 
	        
	        weeklyCalender.fillCalendar(maxDaysInMonth,dayNumberInMonth,mname,year);
	    }
