...
class WeeklyCalenderStack {
    ...
    void fillCalendar(int maxDaysInMonth, int dayNumberInMonth, int month, int year) {
...
public class CalendarStack {
	public static void main(String args[]) {
		...
		WeeklyCalenderStack WeeklyCalenderStack = new WeeklyCalenderStack();

        int maxDaysInMonth = WeeklyCalenderStack.findMaxDay(mname,year);
        
        String firstDayOfMonth=WeeklyCalenderStack.findMonthDay(year,mname);
        
        int dayNumberInMonth = WeeklyCalenderStack.findDayNo(firstDayOfMonth); 
        
        WeeklyCalenderStack.fillCalendar(maxDaysInMonth,dayNumberInMonth,mname,year);
    }
