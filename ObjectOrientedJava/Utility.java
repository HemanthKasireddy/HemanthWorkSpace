...
public class Utility {
	...
	public static int [] shuffleCards(int[] deck) {
			// Shuffle the cards
		ArrayList al=new ArrayList(Arrays.asList(deck));
		for(int i:al)
		...
		int[] al1=new int [52];
		    for (int i = 0; i < deck.length; i++) 
		    {
		     ...
		     // al1[i]=(int)al.remove(index);
		    }
		    return al1;
		}
		
	public static String[] generateCard(String[] arr, int[] deck, String[] suits, String[] ranks) {
		for (int i = 0; i < 52; i++) {
